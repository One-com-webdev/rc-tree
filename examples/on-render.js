...
/***/ function(module, exports, __webpack_require__) {
	...
	var _testData = __webpack_require__(275);
	
	var _testData2 = _interopRequireDefault(_testData);
	
	var _OnRender = __webpack_require__(273);
	...
	var Test = function Test() {
	  return _react2.default.createElement(
	    _src2.default,
	    {
	      onRender: function onRender(e, tree) {
	        return console.log('onRender', e, tree);
	      }
	    },
	    _testData2.default.map(renderNode)
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TreeNode = __webpack_require__(274);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _OnRender2 = _interopRequireDefault(_OnRender);
	...
	var Tree = function (_React$Component) {
	  ...
	  Tree.prototype._tryOnRenderEvent = function _tryOnRenderEvent(cause) {
	    var setContext = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
	
	    if (this.onRenderEvents[cause]) {
	      var context = setContext ? this.onRenderEvents[cause] : null;
	      (0, _OnRender2.default)(this, cause, context);
	      this.onRenderEvents[cause] = null;
	    }
	  };
	
	  Tree.prototype.componentDidMount = function componentDidMount() {
	    (0, _OnRender2.default)(this, _OnRender.OnRender.MOUNT);
	  };
	
	  Tree.prototype.componentDidUpdate = function componentDidUpdate() {
	    this._tryOnRenderEvent(_OnRender.OnRender.SELECT, true /*setContext*/);
	    this._tryOnRenderEvent(_OnRender.OnRender.TOGGLE, true /*setContext*/);
	    this._tryOnRenderEvent(_OnRender.OnRender.DROP, true /*setContext*/);
	  };
	  ...
	  Tree.prototype.onDrop = function onDrop(e, treeNode) {
	    ...
	    this.onRenderEvents[_OnRender.OnRender.DROP] = res;
	  ...
	  Tree.prototype.onExpand = function onExpand(treeNode) {
	    ...
	    this.onRenderEvents[_OnRender.OnRender.TOGGLE] = { expanded: expanded, node: treeNode };
	  ...
	  Tree.prototype.onSelect = function onSelect(treeNode) {
	    this.onRenderEvents[_OnRender.OnRender.SELECT] = { node: treeNode };
...
/***/ function(module, exports) {
	...
	var onRenderCall = function onRenderCall(tree, cause, context) {
	  if (!tree.props.onRender || typeof tree.props.onRender !== 'function') return;else if (!OnRender[cause]) throw new Error('Unknown cause: ' + cause);
	
	  var event = { cause: cause, context: context },
	      treeArg = {
	    dom: tree.refs.tree
	  };
	
	  tree.props.onRender(event, treeArg);
	};
	
	exports.default = onRenderCall;
...
//# sourceMappingURL=on-render.js.map